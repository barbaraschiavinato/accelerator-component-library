...
<Source
  code={`@import "@ntt-data-fe/ui-components/dist/index.css";`}
  language="css"
/>
<Source
  code={`import { Button } from '@ntt-data-fe/ui-components'`}
  language="tsx"
/>
...
- **`contrast`**: A dark-themed button in light mode that is light-themed in dark mode.
  <Story of={ButtonStories.Contrast} />
